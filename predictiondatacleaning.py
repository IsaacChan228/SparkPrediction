...
This module reads the canonical schema from ``predition_input/prediction_data_format``
...
DEFAULT_TRAIN_PATH = Path("predition_input/test.csv")
DEFAULT_SCHEMA_PATH = Path("predition_input/prediction_data_format")
DEFAULT_CLEAN_TRAIN_PATH = Path("predition_input/test_clean.csv")
CSV_ENCODING = "utf-8"
CSV_ERRORS = "replace"
